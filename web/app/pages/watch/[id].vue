...
useSeoMeta({
    title: () =>
        `${movie.title} (${movie.year}) смотреть онлайн в HD качестве`,

    description: () =>
        `Смотреть онлайн фильм «${movie.title}» (${movie.year}) бесплатно. Описание: ${movie.description?.slice(0, 120)}...`,

    ogTitle: () =>
        `${movie.title} (${movie.year}) — смотреть онлайн`,
