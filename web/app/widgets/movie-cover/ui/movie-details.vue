...
<template>
    ...
    <div class="mt-6">
        ...
        <Typography v-if="movie.originalTitle" variant="body" class="mt-1 text-[25px]">
            {{ movie.originalTitle }}
        </Typography>

        <div class="mt-4 flex items-center gap-[13px]">
            <MovieRating v-if="movie.rating.kinopoisk !== null" :value="movie.rating.kinopoisk" label="Kinoarea" />
        ...
        <div class="mt-7.5 flex items-center gap-9.25">
            <Button v-if="movie.trailerUrl" variant="outline" class="h-[71px]">
